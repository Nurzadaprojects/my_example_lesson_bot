...
class Database:
    ...
    def sql_create_table(self):
        ...
        self.connection.execute(sql_quierries.CREATE_LIKE_TABLE_QUERY)
        self.connection.execute(sql_quierries.CREATE_REFERRAL_TABLE_QUERY)
        try:
            self.connection.execute(sql_quierries.ALTER_USER_TABLE)
            self.connection.execute(sql_quierries.ALTER_USER_V2_TABLE)
    ...
    def sql_select_profile(self, tg_id):
        ...
        return self.cursor.execute(
            sql_quierries.SELECT_PROFILE_QUERY,
            (tg_id,)
        ).fetchone()
    ...
    def sql_select_filter_profiles(self, tg_id):
        ...
        return self.cursor.execute(
            sql_quierries.FILTER_LEFT_JOIN_PROFILE_LIKE_QUERY,
            (tg_id, tg_id,)
        ).fetchall()

    def sql_insert_like(self, owner, liker):
        self.cursor.execute(
            sql_quierries.INSERT_LIKE_QUERY,
            (None, owner, liker,)
        )
        self.connection.commit()
    ...
    def sql_update_profile(self, nickname, bio, age, gender, photo, tg_id):
        self.cursor.execute(
            sql_quierries.UPDATE_PROFILE_QUERY,
    ...
    def sql_delete_profile(self, tg_id):
        self.cursor.execute(
            sql_quierries.DELETE_PROFILE_QUERY,
            (tg_id,)
        )
        self.connection.commit()
    ...
    def sql_update_user_link(self, link, tg_id):
        self.cursor.execute(
            sql_quierries.UPDATE_USER_LINK_QUERY,
            (link, tg_id,)
        )
        self.connection.commit()
    ...
    def sql_select_user(self, tg_id):
        ...
        return self.cursor.execute(
            sql_quierries.SELECT_USER_QUERY,
            (tg_id,)
        ).fetchone()
    ...
    def sql_reference_menu_data(self, tg_id):
        ...
        return self.cursor.execute(
            sql_quierries.DOUBLE_SELECT_REFERRAL_USER_QUERY,
            (tg_id,)
        ).fetchone()
    ...
    def sql_select_user_by_link(self, link):
        ...
        return self.cursor.execute(
            sql_quierries.SELECT_USER_BY_LINK_QUERY,
            (link,)
        ).fetchone()

    def sql_insert_referral(self, owner, referral):
        self.cursor.execute(
            sql_quierries.INSERT_REFERRAL_QUERY,
            (None, owner, referral,)
        )
        self.connection.commit()
    ...
    def sql_update_balance(self, owner):
        self.cursor.execute(
            sql_quierries.UPDATE_USER_BALANCE_QUERY,
            (owner,)
        )
        self.connection.commit()